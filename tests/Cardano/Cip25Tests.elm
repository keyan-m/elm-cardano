                ...
                Expect.all
                    [ \_ ->
                        v2PayloadWithAssetMetadata
                            ...
                            validPolicyId
                            validAssetName
                            (E.associativeList E.string E.string [ ( "image", "ipfs://x" ) ])
                            |> expectDecodeFailure
                    , \_ ->
                        v2PayloadWithAssetMetadata
                            (E.int 2)
                            validPolicyId
                            validAssetName
                            (E.associativeList E.string E.string [ ( "name", "A" ) ])
                            |> expectDecodeFailure
                    , \_ ->
                        v2PayloadWithAssetMetadata
                            (E.int 2)
